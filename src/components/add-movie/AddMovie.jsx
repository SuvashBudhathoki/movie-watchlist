...
const AddMovie = () => {
    ...
    const checkMovieExist = (watchlist, result) => watchlist.find(mv => mv.imdbID === result.imdbID)
    ...
    return (
        <div className='mr-auto ml-3'>
            <AddMovieForm onSubmit={onSubmit} onNameChange={onNameChange}
            ...
            {alert && <CustomAlert title={result.Title} type={alert} setAlert={setAlert} />}
